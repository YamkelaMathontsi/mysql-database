...
heading = Label(root, text="Next Of Kin",font=("bold", 20))
...
def finish():
    ...
    #     messagebox.showerror("INVALID", "PLEASE ENTER PROPER ID NUMBER")
            ...
            sql = (
            "INSERT INTO LifeChoices_Nextofkin (name, surname, cell_number, identity_num)"
            "VALUES (%s, %s, %s, %s)"
)
            #data = (x, y, z, m)
...
register = Button(root, text="NEXT", command=finish)
